  ...
  return (
    ...
    flex-row items-start gap-5`}>
      ...
      <div>
        ...
        text-white`}>Hi,I'm <span className="text-[#915eff]">Sunny</span></h1>
        <p className={`${styles.heroSubText} mt-2
        text-white-100`}>
          I am a <span className="text-[#2d559e]">Frontend Web Developer</span> and also trying 
          to <br className="sm:block hidden"/> build web3 projects and in free time i develop feelings for you...
        </p>
      </div>
      </div>
      <ComputersCanvas/>
