  ...
  return (
    ...
    <motion.div variants={textVariant()}>
      ...
      <div className=" w-full flex flex-wrap">
        ...
        >
          I have worked on a few personal and professional side project during my free time to learn new technologies
          I've been working on a lot of different things over the years and have had some great opport
